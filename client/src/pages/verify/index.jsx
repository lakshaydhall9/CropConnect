...
const Verify = () => {
  ...
  const textColor = type === "seller" ? "text-teal-700" : "text-blue-600";
  ...
  const message = {
    ...
    404: {
      ...
      icon: <RxCross2 className="text-teal-600 w-14 h-14" />,
    ...
    409: {
      ...
      icon: <FaRegFaceSmile className="text-blue-600 w-14 h-14 m-2" />,
      sideMessage: (
        <span>
    ...
    200: {
      ...
      icon: <SiTicktick className="text-teal-600 w-14 h-14 m-2" />,
      sideMessage: (
        <span>
          Redirecting in {timeLeft} seconds <br /> or you can go back to the
          previous tab
